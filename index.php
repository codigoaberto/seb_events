...
.fc-calendar .fc-row > div > article > span.fc-date {
	position: relative;
	width: 30px;
	height: 20px;
	font-size: 20px;
...
.fc-calendar .fc-row > div > article > span.fc-weekday {
	padding-left: 5px;
	display: none;
}

.fc-calendar .fc-row > article > div.fc-today {
	background: #fff4c3;
}

.fc-calendar .fc-row > article > div.fc-out {
	opacity: 0.6;
}
...
.custom-header h3 {font-size: 30px;
line-height: 1;
font-weight: 700;
color: #b7bbc2;
margin: 0;
...
.fc-calendar .fc-row > div.fc-today > article > span.fc-date {
	color: #fff;
