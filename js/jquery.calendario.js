			...
			for ( var i = 0; i < 7; i++ ) {
				...
				for ( var j = 0; j <= 6; j++ ) {
					...
					if ( day <= monthLength && ( i > 0 || j >= p ) ) {
						...
						inner += '<article class="inside"><span class="fc-date">' + day + '</span><span class="fc-weekday">' + this.options.weekabbrs[ j + this.options.startIn > 6 ? j + this.options.startIn - 6 - 1 : j + this.options.startIn ] + '</span>';
						...
						if( content !== '' ) {
						if (this.options.popover == "popover") {
								contentAttr = ' class="fc-popover '+this.options.popoverSelector+'" title="'+dayData.title+'" data-content="'+dayData.text+'"';
							} else if (this.options.popover == "slideover") {
								contentAttr = ' class="fc-slideover" data-title="'+dayData.title+'" data-content="'+dayData.text+'"';
							}
							inner += '<div'+contentAttr+'>' + content + '</div>';
						}
